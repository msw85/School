...
def generateData(quantity, road, id):
    ...
    for i in range(quantity):
        ...
        #Picking a roadname from the system argument within the roadtype and sets the speed for the vehicle after.
...
#Calls the method with 3 system argument
generateData(int(sys.argv[1]), str(sys.argv[2]), int(sys.argv[3]))